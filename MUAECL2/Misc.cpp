...
const map<Operator, int> Op::Op_f = { { LogicalOr, 2 },{ LogicalAnd, 4 },{ Or, 6 },{ And, 8 },{ BitOr, 10 },{ BitXor, 12 },{ BitAnd, 14 },{ EqualTo, 16 },{ NotEqual, 16 },{ Less, 18 },{ LessEqual, 18 },{ Greater, 18 },{ GreaterEqual, 18 },{ Plus, 20 },{ Minus, 20 },{ Times, 22 },{ Divides, 22 },{ Mod, 22 },{ Negative, 22 },{ Not, 22 },{ Dot, 24 },{ Sin, 22 },{ Cos, 22 },{ Sqrt, 22 },{ Bra, 0 },{ Ket, 24 },{ End, 0 } };
const map<Operator, int> Op::Op_g = { { LogicalOr, 1 },{ LogicalAnd, 3 },{ Or, 5 },{ And, 7 },{ BitOr, 9 },{ BitXor, 11 },{ BitAnd, 13 },{ EqualTo, 15 },{ NotEqual, 15 },{ Less, 17 },{ LessEqual, 17 },{ Greater, 17 },{ GreaterEqual, 17 },{ Plus, 19 },{ Minus, 19 },{ Times, 21 },{ Divides, 21 },{ Mod, 21 },{ Negative, 25 },{ Not, 25 },{ Dot, 23 },{ Sin, 25 },{ Cos, 25 },{ Sqrt, 25 },{ Bra, 25 },{ Ket, 0 },{ End, 0 } };
const map<Operator, int> Op::id = { { LogicalOr, 2 },{ LogicalAnd, 2 },{ Or, 2 },{ And, 2 },{ BitOr, 2 },{ BitXor, 2 },{ BitAnd, 2 },{ EqualTo, 2 },{ NotEqual, 2 },{ Less, 2 },{ LessEqual, 2 },{ Greater, 2 },{ GreaterEqual, 2 },{ Plus, 2 },{ Minus, 2 },{ Times, 2 },{ Divides, 2 },{ Mod, 2 },{ Negative, 1 },{ Not, 1 },{ Dot, 2 },{ Sin, 1 },{ Cos, 1 },{ Sqrt, 1 },{ Bra, 0 },{ Ket, 0 },{ End, 0 } };
